...
const card: Card = {
	...
	effect: {
		...
		fr: "Tous dégâts infligés par des attaques de Pokémon {L} (les vôtres et ceux de votre adversaire) au Pokémon Défenseur ne sont pas affectés par la Résistance. Chaque Pokémon {L} en jeu (les vôtres et ceux de votre adversaire) ne possède pas de Faiblesse.",
