...
const card: Card = {
	...
	effect: {
		fr: "Cette carte ne peut être attachée qu'à un Pokémon {F}. Cette carte ne fournit de l'Énergie {F} que pendant qu'elle est attachée à un Pokémon {F}.\n\nLes attaques du Pokémon {F} auquel cette carte est attachée infligent 20 dégâts supplémentaires au Pokémon Actif de votre adversaire (avant application de la Faiblesse et de la Résistance).\n\n(Si cette carte est attachée à autre chose qu'un Pokémon {F}, défaussez cette carte.)",
