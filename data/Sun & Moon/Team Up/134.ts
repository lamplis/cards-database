...
const card: Card = {
	...
	effect: {
		...
		fr: "Lorsqu'un Pokémon {D} (le vôtre ou celui de votre adversaire) auquel de l'Énergie {D} est attachée est mis K.O. par les dégâts d'une attaque d'un adversaire, ce joueur récupère une carte Récompense de moins.\n\nChaque fois qu'un joueur joue une carte Objet ou une carte Supporter de sa main, évitez tous les effets de cette carte-là sur cette carte Stade.",
		...
		de: "Du kannst nicht mehr als 1 ◇-Karte mit demselben Namen in deinem Deck haben. Wenn 1 ◇-Karte auf deinen Ablagestapel gelegt würde, lege sie stattdessen ins Nirgendwo. Wenn ein {D}-Pokémon (deins oder das deines Gegners), an das mindestens 1 {D}-Energie angelegt ist, durch den Schaden einer Attacke des Gegners kampfunfähig wird, nimmt jener Spieler 1 Preiskarte weniger. Verhindere jedes Mal, wenn ein Spieler eine Item- oder Unterstützerkarte aus seiner Hand spielt, alle Effekte jener Karte, die dieser Stadionkarte zugefügt werden. Diese Karte bleibt im Spiel, wenn du sie spielst. Lege diese Karte ab, sobald eine weitere Stadionkarte ins Spiel kommt. Wenn eine andere Karte mit dem gleichen Namen im Spiel ist, kannst du diese Karte nicht spielen."
	},
