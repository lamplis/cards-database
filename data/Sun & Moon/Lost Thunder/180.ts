...
const card: Card = {
	...
	effect: {
		...
		fr: "Une seule fois pendant le tour de chaque joueur, ce joueur peut soigner 60 dégâts et retirer tous les États Spéciaux de l'un de ses Pokémon {G}.\n\nChaque fois qu'un joueur joue une carte Objet ou une carte Supporter de sa main, évitez tous les effets de cette carte-là sur cette carte Stade.",
		...
		de: "Du kannst nicht mehr als 1 ◇-Karte mit demselben Namen in deinem Deck haben. Wenn 1 ◇-Karte auf deinen Ablagestapel gelegt würde, lege sie stattdessen ins Nirgendwo. Einmal während des Zuges jedes Spielers kann der Spieler bei 1 seiner {G}-Pokémon 60 Schadenspunkte heilen und alle Speziellen Zustände von jenem Pokémon entfernen. Verhindere jedes Mal, wenn ein Spieler eine Item- oder Unterstützerkarte aus seiner Hand spielt, alle Effekte jener Karte, die dieser Stadionkarte zugefügt werden. Diese Karte bleibt im Spiel, wenn du sie spielst. Lege diese Karte ab, sobald eine weitere Stadionkarte ins Spiel kommt. Wenn eine andere Karte mit dem gleichen Namen im Spiel ist, kannst du diese Karte nicht spielen."
	},
