...
const card: Card = {
	...
	effect: {
		fr: "Jouez cette carte comme si c'était un Pokémon {C} de base avec 60 PV. N'importe quand pendant votre tour (avant votre attaque), vous pouvez défausser cette carte du jeu.\n\nCette carte ne peut pas battre en retraite.",
