...
const card: Card = {
	...
	effect: {
		fr: "Vous ne pouvez utiliser cette carte que si vous défaussez 2 autres cartes de votre main.\n\nAjoutez jusqu'à 4 cartes Énergie de base de votre pile de défausse à votre main. (Vous ne pouvez pas choisir une carte que vous avez défaussée du fait de l'effet de cette carte.)",
