...
const card: Card = {
	...
	effect: {
		...
		fr: "Jouez cette carte comme si c'était un Pokémon {C} de base avec 60 PV. Cette carte ne peut être affectée par aucun État Spécial et ne peut pas battre en retraite. À tout moment pendant votre tour, vous pouvez défausser cette carte du jeu.",
